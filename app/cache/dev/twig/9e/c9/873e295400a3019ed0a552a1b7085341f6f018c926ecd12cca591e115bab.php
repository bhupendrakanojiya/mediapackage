...
class __TwigTemplate_9ec9873e295400a3019ed0a552a1b7085341f6f018c926ecd12cca591e115bab extends Twig_Template
{
    ...
    <table class=\"record_properties table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 14
        echo twig_escape_filter($this->env, $this->getAttribute($this->getContext($context, "entity"), "active", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Id</th>
    ...
    <li>
        <a href=\"";
        // line 30
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("channels_edit", array("id" => $this->getAttribute($this->getContext($context, "entity"), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
