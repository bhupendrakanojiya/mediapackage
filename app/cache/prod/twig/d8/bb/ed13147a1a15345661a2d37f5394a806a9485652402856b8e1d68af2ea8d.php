...
class __TwigTemplate_d8bbed13147a1a15345661a2d37f5394a806a9485652402856b8e1d68af2ea8d extends Twig_Template
{
    ...
    <table class=\"record_properties table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 14
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "active", array()), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Id</th>
    ...
    <li>
        <a href=\"";
        // line 30
        echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("channels_edit", array("id" => $this->getAttribute((isset($context["entity"]) ? $context["entity"] : null), "id", array()))), "html", null, true);
        echo "\">
            Edit
        </a>
    </li>
